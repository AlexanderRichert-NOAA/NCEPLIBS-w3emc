...
C>  - 5): smoothing flag.
C> @param[in] kprob integer (2) probability ensemble parms.
C> @param[in] xprob real (2) probability ensemble parms.
C> @param[in] kclust integer (16) cluster ensemble parms.
C> @param[in] kmembr integer (8) cluster ensemble parms.

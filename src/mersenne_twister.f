!> @file
!> @brief Modern random number generator.
...
!>
!> @note Here are the comments in the original open source code:
...
!>
!> @note On a single IBM Power4 processor on the NCEP operational cluster (2005)

C> @file
C> @brief Convert (361,91) grid to (101,81) lambert grid.
...
C> @param[out] ALAMB 101*81 regional - central us mard double res.
C> (lambert conformal). 8181 point grid is awips grid type 209
C>
C> @note

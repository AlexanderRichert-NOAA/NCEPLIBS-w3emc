! This program tests getgbep().
program test_getgbep
  implicit none
  ...
  lugi=0
  jg=jgmax
  call getgbep(lugb,lugi,jg,j,jpds,jgds,jens,kg,k,kpds,kgds,kens,g,iret)
  if(iret.ne.0) stop 2
  ...
  ! Case 3: too-small output buffer should return the length error code.
  jpds=-1
  jgds=-1
  jens=-1
  kpds=0
  ...
  ! Case 4: invalid index unit should hit index-read error handling.
  jpds=-1
  jgds=-1
  jens=-1
  kpds=0
